package com.colosseum.coloutil
...
import com.colosseum.coloutil.clock.DateProvider
import com.colosseum.coloutil.clock.SystemDateProvider
...
object FilenameUtil {
    ...
    fun encode(fileName: String): String = URLEncoder.encode(fileName, StandardCharsets.UTF_8.name())
    ...
    fun appendSuffixWithDate(fileName: String, suffix: String?, clockProvider: DateProvider): String {
    ...
    fun appendSuffixWithDate(fileName: String, suffix: String? = null): String =
        appendSuffixWithDate(fileName, suffix, SystemDateProvider())
}
